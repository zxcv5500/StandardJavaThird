...
/**
 * @author zxcv5500
 * 날짜 계산을 위한 몇가지 메서드를 직접 구현해 본 소스
 */
class CalendarEx9 {

	public static void main(String[] args) {
		System.out.println("2014. 5. 31 : " + getDayOffWeek(2014, 5, 31));
		System.out.println("2012. 6. 1 : " + getDayOffWeek(2012, 6, 1));
	...
	// 각 달의 마지막일
	public static int[] endOfMonth = { 31, 28, 31, 30, 31, 30, 31,
			31, 30, 31, 30, 31};
	...
	// 지정한 날짜의 요일을 반환한다.
	public static int getDayOffWeek(int year, int month, int day) {
